...
In this release we make the platform more stable and test with our first client.

So we make the platform more independent to tour guide, as well as giving the admin more control over the platform.

We create a first prototype of our guidebook, that will support tour guides that can be sent and sold for a user.
...
- A lot of permission bugs and conflict between admin accounts
- Truppies on maps to explore (thanks to 
- Improve in Truppie places, but will deserve a release just for that
- Release of http://dev.truppie.com using Github Pages that makes a open source documentation accessible
